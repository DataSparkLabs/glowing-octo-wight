...
define('DB_USER', 'c1nationalach');

/** MySQL database password */
define('DB_PASSWORD', 'Nationalach1');
...
define('DB_COLLATE', '');
define('WP_HOME','http://nationalach.funneldevelopment.com/');
define('WP_SITEURL','http://nationalach.funneldevelopment.com/');
/**#@+
