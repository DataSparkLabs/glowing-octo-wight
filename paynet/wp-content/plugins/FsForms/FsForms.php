...
class FsForms
{
//    public static $leela_script = 'http://crm.funnelscience.com/leela.php';
//    public static $nibbler_script = 'http://crm.funnelscience.com/nibbler.php';
//    public static $fry_script = 'http://localhost/~rudyard/FsCRM/src/fry.php';
    ...
    {
        global $fs_forms_url;
        $fs_forms_url = plugins_url() . '/FsForms/';
        if(is_admin())
        {        
    ...
    public static function get_leela()
    {
        return self::get_crm_url().'leela.php';
    }
    public static function get_nibbler()
    {
        return self::get_crm_url().'nibbler.php';
    }
    ...
    function init()
    {
        ...
        wp_enqueue_style('jquery.ui.css', $fs_forms_url.'lib/jQueryUI/css/smoothness/jquery-ui-1.10.3.custom.min.css');  
        wp_enqueue_script('jquery.cookie.js', $fs_forms_url.'lib/jquery.cookie.js', array('jquery'));   
        wp_register_script('jquery.ui.js', $fs_forms_url.'lib/jQueryUI/js/jquery-ui-1.10.3.custom.min.js', array('jquery'));  
    ...
    {
        add_menu_page( 'FS Forms', 'FS Forms', 'manage_options', 'fs-forms', array(&$this, 'forms_main_page'), plugins_url().'/FsForms/images/funnel-icon.png'); 
	...
	?>
        <div class="wrap">
            <?php screen_icon('themes'); ?> <h2>Funnel Science Forms</h2>
